  ...
  <footer class="footer">
    ...
    <div class="fbody">
      ...
      <div class="fcol fcol-brand">
        <div class="fbrand-logo">
          ...
          <span class="fbrand-name">Zeem<span class="fbrand-accent">ler</span></span>
        </div>
    ...
    <div class="fbar">
      <span class="fbar-copy">
        © {{ year }} <span class="fbar-brand">Zeemler</span> — {{ $t('footer.copyright') }}
      </span>
      ...
      <div class="fbar-social">
        <!-- Telegram -->
        <a href="https://t.me/zeemler" target="_blank" rel="noopener" class="fsoc-btn">
        ...
        <!-- X / Twitter -->
        <a href="https://twitter.com/zeemler" target="_blank" rel="noopener" class="fsoc-btn">
          <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor">
            <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.744l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
          </svg>
        </a>
        <!-- Instagram -->
        <a href="https://instagram.com/zeemler" target="_blank" rel="noopener" class="fsoc-btn">
          <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor">
