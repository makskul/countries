export default {
  home: {
    title: 'Zeemler — Отзывы эмигрантов о странах по национальности',
  ...
  about: {
    title: 'О проекте',
    description: 'Zeemler — платформа реальных отзывов эмигрантов о странах, отфильтрованных по национальности.',
  },
  rules: {
    title: 'Правила сайта',
    description: 'Правила публикации отзывов на Zeemler.',
  },
  privacy: {
    title: 'Политика конфиденциальности',
    description: 'Как Zeemler собирает и обрабатывает данные пользователей.',
  },
  contact: {
    title: 'Связаться с нами',
    description: 'Есть вопросы или предложения? Напишите команде Zeemler.',
  },
}
