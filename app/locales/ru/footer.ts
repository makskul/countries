export default {
  brand: { description: 'Реальные отзывы эмигрантов о жизни в разных странах — отфильтрованные по твоей национальности.' },
  ...
  disclaimer: 'Все отзывы написаны реальными пользователями и отражают их личный опыт. NationView не несёт ответственности за актуальность информации.',
