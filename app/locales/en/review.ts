export default {
  ...
  fields: { country: 'Country you are reviewing *', nationality: 'Your nationality *', city: 'City', cityPlaceholder: 'Start typing city name...', cityDisabledHint: 'Please select a country first', citySelectFromList: 'Please select a city from the list', profile: 'Your role in this country', profilePlaceholder: 'Select your status...' },
