...
6. **SEO** — в карточке страны блок «SEO (title / description)» для UK / EN / RU. Пустые поля = стандартный title/description сайта.
7. **Журнал изменений** — модерация отзывов + правки CMS (страны, города, медиа).
